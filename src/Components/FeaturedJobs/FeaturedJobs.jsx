...
const FeaturedJobs = () => {
    ...
    return (
        <div className='container mx-auto'>
            <h1 className='text-3xl md:text-5xl font-bold mt-10 mb-3'>Featured Jobs</h1>
            <p><small>Explore thousands of job opportunities with all the information you need. It's your future</small></p>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-3'>
                {jobAndCompaneyLogo.map(job => (
                    <FeaturedJobsLists key={job.id} job={job}></FeaturedJobsLists>
                ))}
            </div>
        </div>
    );
